...
parser.add_argument(
    "--month", help="Month to plot", type=int, required=False, default=6
)
parser.add_argument(
    "--year", help="Year to plot", type=int, required=False, default=2014
)

parser.add_argument(
    "--variable", help="Variable to plot", type=str, required=False, default='pr'
)

args = parser.parse_args()

raw = load_raw(args.year, args.month, variable=args.variable)
...
fig.savefig(plotdir+"tensor_test.png")